...
### Ouvrir et sauvegarder un fichier de données en format R
Les données pour les exercices de laboratoire et pour les devoirs vous sont fournies déjà en format R (fichiers avec extension .Rdata).
...
```{r load_stur, include = FALSE}
load("data/sturgeon.Rdata")
```
