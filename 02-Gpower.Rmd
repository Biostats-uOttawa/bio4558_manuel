...
![Analyse post-hoc avec la taille d'effet estimée](images/gpower_1.png)
...
![Analyse post-hoc avec une taille d'effet différente\label{gpower_2}](images/gpower_2.png)
<!-- ```{r,2}
knitr::include_graphics("images/gpower_2.png")
``` -->
<!-- \begin{figure}[H]
  \includegraphics{images/gpower_2.png}
  \caption{Analyse post-hoc avec une taille d'effet différente}
\end{figure} -->
...
![Analyse à priori](images/gpower_3.png)
<!-- \begin{figure}[ht]
  \includegraphics{images/gpower_3.png}
  \caption{Analyse à priori}
\end{figure} -->
...
![Analyse de sensitivité](images/gpower_4.png)
<!-- \begin{figure}[ht]
  \includegraphics{images/gpower_4.png}
  \caption{Analyse de sensitivité}
\end{figure} -->
