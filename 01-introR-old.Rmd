...
Je vous suggère fortement de lire ;les chapitres 2 et 8 du livre de Julien Barnier [Introduction à R et au *tidyverse*](https://juba.github.io/tidyverse/).Je suggère aussi de lire le livre d'emmanuel Paradis, [R pour les débutants](https://cran.r-project.org/doc/contrib/Paradis-rdebuts_fr.pdf). Ces 2 livres décrivent très bien les notions de bases de R.
