...
Attrape. Notez que j’ai utilisé la fonction Anova() du package car avec
...
nificativement de la normalité. Les résidus semblent


homoscédastiques, mais si vous voulez vous en assurer, vous
...
1.8513 0.1771
lage
0.14338 1 178.1627 <2e-16 ***
Residuals
0.07162 89
---
Signif. codes: 0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
Call:
lm(formula = lfkl ~ sex + lage, data = mydata)
...
conséquent, les bénéfices de l’inclusion d’un terme pour les


différentes ordonnées à l’origine sont faibles alors que le coût, en
