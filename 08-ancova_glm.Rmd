...
Par défaut, la variable locate iest encodée comme 0 pour le site qui vient le premier en ordre alphabétique (LofW) et 1 pour l’autre (Nelson). Les régressions pour chaque site deviennent donc:

Pour LofW:
$$\begin{align}
lfkl_{LofW} &= 1.2284 + 0.3253 \times lage + 0.2207 \times locate_{LofW} - 0.1656 \times locate_{LofW} \times lage \\
lfkl_{LofW} &= 1.2284 + 0.3253 \times lage + 0.2207 \times 0 - 0.1656 \times 0 \times lage \\
 &= 1.2284 + 0.3253 \times lage
\end{align}$$

Pour Nelson:
$$\begin{align}
lfkl_{Nelson} &= 1.2284 + 0.3253 \times lage + 0.2207 \times locate_{Nelson} - 0.1656 \times locate_{Nelson} \times lage \\
lfkl_{Nelson} &= 1.2284 + 0.3253 \times lage + 0.2207 \times 1 - 0.1656 \times 1 \times lage \\
