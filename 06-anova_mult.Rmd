...
- Le fichier `nestdat.csv` contient les résultats d'une expérience sem- blable. Il contient trois variables : genotype, chamber et survival. Effectuez une ANOVA hiérarchique avec survival comme variable dépendante et genotype et chamber/genotype comme variables indépendantes.
...
```{r}
wmc2dat2$species.conc <- as.factor(paste(wmc2dat2$species,wmc2dat2$conc))
```
