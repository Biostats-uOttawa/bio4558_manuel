...
## t1* 1.1919926  0.0012138060  0.03398221
## t2* 0.3408557 -0.0008575881  0.02676912
\end{verbatim}
...
## Intervals : 
## Level      Normal              Basic         
## 95%   ( 1.124,  1.257 )   ( 1.127,  1.259 )  
## 
## Level     Percentile            BCa          
## 95%   ( 1.125,  1.257 )   ( 1.108,  1.244 )  
...
## Intervals : 
## Level      Normal              Basic         
## 95%   ( 0.2892,  0.3942 )   ( 0.2869,  0.3909 )  
## 
## Level     Percentile            BCa          
## 95%   ( 0.2908,  0.3948 )   ( 0.2979,  0.4029 )  
## Calculations and Intervals on Original Scale
\end{verbatim}
...
## Bootstrap Statistics :
##      original       bias    std. error
## t1* 45.084391 -0.007582037   0.4346985
## t2* -1.714546  0.003883484   0.7976184
\end{verbatim}
...
## Linear Hypotheses:
##                    Estimate lwr      upr     
## m1958 - m1954 == 0   0.1872  -3.2750   3.6495
## m1965 - m1954 == 0  -5.5077 -10.0022  -1.0132
## m1966 - m1954 == 0  -3.3127  -6.3465  -0.2789
## m1965 - m1958 == 0  -5.6949 -10.4165  -0.9733
## m1966 - m1958 == 0  -3.4999  -6.8610  -0.1388
## m1966 - m1965 == 0   2.1950  -2.2221   6.6120
\end{verbatim}
...
## 0.5%  -0.70353951 0.1288834 -0.046140816 0.01738200 -0.0003461736
## 1%    -0.68517697 0.1367008 -0.044918933 0.01850803 -0.0003402218
## 2.5%  -0.64000305 0.1490951 -0.042452866 0.01995648 -0.0003232998
## 5%    -0.59640904 0.1632726 -0.039573041 0.02118379 -0.0003128049
## 95%   -0.05325019 0.2793116 -0.012163666 0.03731436 -0.0001820193
## 97.5% -0.02206293 0.2917430 -0.008909406 0.03909895 -0.0001720539
## 99%    0.05659680 0.3036678 -0.004694270 0.04074233 -0.0001625919
## 99.5%  0.07880594 0.3100134 -0.004151672 0.04145895 -0.0001508128
\end{verbatim}
...
\CommentTok{# bootstrapping with 1000 replications}
\NormalTok{results <-}\StringTok{ }\KeywordTok{boot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ mydata, }\DataTypeTok{statistic =}\NormalTok{ bs, }\DataTypeTok{R =} \DecValTok{1000}\NormalTok{,}
\DataTypeTok{formula =}\NormalTok{ myformula)}
\CommentTok{# view results}
\NormalTok{results}
...
## Residual deviance: 7.5131e-12  on  0  degrees of freedom
## AIC: 237.31
## 
