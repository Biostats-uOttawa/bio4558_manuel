...
## t1* 1.1919926  0.002734212  0.03406241
## t2* 0.3408557 -0.001959686  0.02701840
\end{verbatim}
...
## Intervals : 
## Level      Normal              Basic         
## 95%   ( 1.122,  1.256 )   ( 1.120,  1.257 )  
## 
## Level     Percentile            BCa          
## 95%   ( 1.127,  1.264 )   ( 1.100,  1.244 )  
...
## Intervals : 
## Level      Normal              Basic         
## 95%   ( 0.2899,  0.3958 )   ( 0.2893,  0.3962 )  
## 
## Level     Percentile            BCa          
## 95%   ( 0.2855,  0.3924 )   ( 0.2990,  0.4125 )  
## Calculations and Intervals on Original Scale
## Some BCa intervals may be unstable
\end{verbatim}
...
## Bootstrap Statistics :
##      original      bias    std. error
## t1* 45.084391  0.02475926   0.4412302
## t2* -1.714546 -0.02362741   0.7638635
\end{verbatim}
...
\tightlist
\item
  \texttt{Iter}: la règle a limité à 5000 permutations le calcul. Notez que ce nombre va varier à chaque fois que vous tournerez cet petit bout de code. Ce sont des résultats obtenus par permutations aléatoires, donc vous devez vous attendre à de la variabilité. .
\item
  \texttt{Pr(Prob)}: La p-valeur estimée pour H0 est 0.0146. La différence observée pour fklngth between entre les deux sites était plus grande que les valeurs permutées environ (1 - 0.0146= 98.5\%) des 5000 permutations. Notez que 5000 permutations ce n'est pas un si grand nombre de permutations que ça, et donc les faibles valeurs de p ne sont pas très précises. Si vous voulez des valeurs précises de p, vous devrez faire plus de permutations. Vous pouvez ajuster 2 paramètres: maxIter, le nombre maximal de permutations (défaut 5000) et Ca, le seuil de précision désiré qui arrête les permutations quand l'erreur- type de p est plus petite que Ca*p (défaut=0.1)
\item
...
## Linear Hypotheses:
##                    Estimate lwr      upr     
## m1958 - m1954 == 0   0.1872  -3.2718   3.6462
## m1965 - m1954 == 0  -5.5077  -9.9980  -1.0174
## m1966 - m1954 == 0  -3.3127  -6.3437  -0.2817
## m1965 - m1958 == 0  -5.6949 -10.4121  -0.9777
## m1966 - m1958 == 0  -3.4999  -6.8579  -0.1420
## m1966 - m1965 == 0   2.1950  -2.2180   6.6079
\end{verbatim}
...
## 0.5%  -0.74179020 0.1348058 -0.047855492 0.01756503 -0.0003625146
## 1%    -0.72606861 0.1402197 -0.045139744 0.01838184 -0.0003469934
## 2.5%  -0.67586984 0.1542842 -0.042566690 0.02010243 -0.0003306843
## 5%    -0.61564617 0.1614941 -0.039306784 0.02148417 -0.0003173606
## 95%   -0.09367427 0.2824555 -0.011198316 0.03790317 -0.0001855977
## 97.5% -0.03773784 0.2926352 -0.008198877 0.03988127 -0.0001754762
## 99%    0.02586879 0.3080263 -0.005764158 0.04226297 -0.0001603057
## 99.5%  0.06293586 0.3146700 -0.002309645 0.04364566 -0.0001532750
\end{verbatim}
