...
## t1* 1.1919926  0.002378721  0.03569537
## t2* 0.3408557 -0.001652903  0.02822625
\end{verbatim}
...
## Intervals : 
## Level      Normal              Basic         
## 95%   ( 1.120,  1.260 )   ( 1.120,  1.262 )  
## 
## Level     Percentile            BCa          
## 95%   ( 1.122,  1.264 )   ( 1.114,  1.251 )  
...
## Intervals : 
## Level      Normal              Basic         
## 95%   ( 0.2872,  0.3978 )   ( 0.2842,  0.3966 )  
## 
## Level     Percentile            BCa          
## 95%   ( 0.2851,  0.3975 )   ( 0.2913,  0.4013 )  
## Calculations and Intervals on Original Scale
\end{verbatim}
...
## Bootstrap Statistics :
##      original      bias    std. error
## t1* 45.084391 0.003691577   0.4465739
## t2* -1.714546 0.028614964   0.7641701
\end{verbatim}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-202-1.pdf}
\caption{\label{fig:unnamed-chunk-202}Boxplot de la longueur pas annéee}
\end{figure}
...
## Linear Hypotheses:
##                    Estimate lwr      upr     
## m1958 - m1954 == 0   0.1872  -3.2694   3.6438
## m1965 - m1954 == 0  -5.5077  -9.9948  -1.0205
## m1966 - m1954 == 0  -3.3127  -6.3415  -0.2839
## m1965 - m1958 == 0  -5.6949 -10.4087  -0.9810
## m1966 - m1958 == 0  -3.4999  -6.8555  -0.1443
## m1966 - m1965 == 0   2.1950  -2.2148   6.6048
\end{verbatim}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-209-1.pdf}
\caption{\label{fig:unnamed-chunk-209}Conditions d'application ANOVA model1}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-216}Effet du sexe et du lieu sur le poids des esturgeons}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-226}Effet du mois et de la profondeur sur la température}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-227}Conditions d'applications du modèle anova.model4}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-231}Conditions d'applications du modèle anova.nested}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-233}Effet du genotype sur la résistance à la dessication avec un test de Tukey}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-234}Conditions d'applications du modèle anova.simple}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-244}Comparaison de Tukey des moyennes de consommation d'oxygèn en fonction del la concentration}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-251}Matrice de rélation et densité pour la richesse spécifique des amphibiens et reptiles}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-252}Conditions d'applications de la régression de \emph{logherp} sur \emph{logarea}}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-261}Relation entre swamp et les résidus de la régression entre logherp et logarea}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-264}Relation}
\end{figure}
...
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-268-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-273-1.pdf}
\caption{\label{fig:unnamed-chunk-273}Graphiques de résidus partiels du modèle \texttt{model.poly2}}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-274}Graphiques de résidus partiels du modèle \texttt{model.nopoly}}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-288-1.pdf}
\caption{\label{fig:unnamed-chunk-288}Distribution des estimé par bootstrap pour \texttt{logarea}}
\end{figure}
...
## 0.5%  -0.73698985 0.1277441 -0.0494835045 0.01689310 -0.0003462060
## 1%    -0.69539516 0.1387070 -0.0457182990 0.01842570 -0.0003372946
## 2.5%  -0.64875337 0.1547725 -0.0421770050 0.01923256 -0.0003275330
## 5%    -0.60254244 0.1668883 -0.0400004808 0.02107618 -0.0003131259
## 95%   -0.08099397 0.2805487 -0.0107205270 0.03789797 -0.0001803205
## 97.5% -0.02428049 0.2883705 -0.0073217847 0.03903605 -0.0001671496
## 99%    0.02558482 0.3044692 -0.0041703200 0.04058086 -0.0001570792
## 99.5%  0.04473608 0.3116818  0.0005128487 0.04116381 -0.0001460935
\end{verbatim}
...
\caption{\label{fig:unnamed-chunk-296}Longueur des esturgeons en fonction de l'age}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-298}Conditions d'applications du modèle \texttt{model.full1}}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-303-1.pdf}
\caption{\label{fig:unnamed-chunk-303}Longueur des esturgeons en fonction de l'age d'après \texttt{anc3dat}}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-304}Conditions d'applications du modèle \texttt{model.full2}}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-324-1.pdf}
\caption{\label{fig:unnamed-chunk-324}Représentation mosaique de la proportion des sexes par classe d'age}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-333-1.pdf}
\caption{\label{fig:unnamed-chunk-333}Proportion de plantes infectées en fonction de la température er la lumière}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-336}Fréquence de femelles et males en fonction de l'année et du lieu}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-342-1.pdf}
\caption{\label{fig:unnamed-chunk-342-1}Exemple de graphique tiré du fichier d'aide de la fonction stat\_bin}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-342-2.pdf}
\caption{\label{fig:unnamed-chunk-342-2}Exemple de graphique tiré du fichier d'aide de la fonction stat\_bin}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-342-3.pdf}
\caption{\label{fig:unnamed-chunk-342-3}Exemple de graphique tiré du fichier d'aide de la fonction stat\_bin}
\end{figure}
