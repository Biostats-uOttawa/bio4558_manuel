...
## t1* 1.1919926  0.0006063349  0.03319161
## t2* 0.3408557 -0.0003183020  0.02631644
\end{verbatim}
...
## Intervals : 
## Level      Normal              Basic         
## 95%   ( 1.126,  1.256 )   ( 1.126,  1.254 )  
## 
## Level     Percentile            BCa          
## 95%   ( 1.130,  1.258 )   ( 1.120,  1.250 )  
...
## Intervals : 
## Level      Normal              Basic         
## 95%   ( 0.2896,  0.3928 )   ( 0.2902,  0.3933 )  
## 
## Level     Percentile            BCa          
## 95%   ( 0.2884,  0.3915 )   ( 0.2927,  0.3959 )  
## Calculations and Intervals on Original Scale
\end{verbatim}
...
## Bootstrap Statistics :
##      original        bias    std. error
## t1* 45.084391 -0.0024378124   0.4416405
## t2* -1.714546  0.0001437761   0.7770123
\end{verbatim}
...
\tightlist
\item
  \texttt{Iter}: la règle a limité à 1782 permutations le calcul. Notez que ce nombre va varier à chaque fois que vous tournerez cet petit bout de code. Ce sont des résultats obtenus par permutations aléatoires, donc vous devez vous attendre à de la variabilité. .
\item
  \texttt{Pr(Prob)}: La p-valeur estimée pour H0 est 0.0533. La différence observée pour fklngth between entre les deux sites était plus grande que les valeurs permutées environ (1 - 0.0533= 94.7\%) des 1782 permutations. Notez que 1782 permutations ce n'est pas un si grand nombre de permutations que ça, et donc les faibles valeurs de p ne sont pas très précises. Si vous voulez des valeurs précises de p, vous devrez faire plus de permutations. Vous pouvez ajuster 2 paramètres: maxIter, le nombre maximal de permutations (défaut 5000) et Ca, le seuil de précision désiré qui arrête les permutations quand l'erreur- type de p est plus petite que Ca*p (défaut=0.1)
\item
...
## 0.5%  -0.711877920 0.1200470 -0.046261959 0.01700882 -0.0003442958
## 1%    -0.694023058 0.1303715 -0.044506895 0.01803607 -0.0003347814
## 2.5%  -0.652644009 0.1515682 -0.041827238 0.01993444 -0.0003257225
## 5%    -0.603356933 0.1623907 -0.038963222 0.02172007 -0.0003146377
## 95%   -0.088785058 0.2802413 -0.010629028 0.03791522 -0.0001859053
## 97.5% -0.049267030 0.2873975 -0.007935330 0.03919438 -0.0001710589
## 99%   -0.004626881 0.2989537 -0.005754757 0.04010749 -0.0001552270
## 99.5%  0.044665950 0.3113671 -0.002832472 0.04167855 -0.0001511454
\end{verbatim}
