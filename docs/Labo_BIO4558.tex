...
## t1* 1.1919926  0.002842619  0.03442398
## t2* 0.3408557 -0.002239732  0.02717731
\end{verbatim}
...
## Intervals : 
## Level      Normal              Basic         
## 95%   ( 1.122,  1.257 )   ( 1.119,  1.258 )  
## 
## Level     Percentile            BCa          
## 95%   ( 1.126,  1.265 )   ( 1.112,  1.249 )  
...
## Intervals : 
## Level      Normal              Basic         
## 95%   ( 0.2898,  0.3964 )   ( 0.2887,  0.3966 )  
## 
## Level     Percentile            BCa          
## 95%   ( 0.2851,  0.3930 )   ( 0.2963,  0.4064 )  
## Calculations and Intervals on Original Scale
## Some BCa intervals may be unstable
\end{verbatim}
...
## Bootstrap Statistics :
##      original       bias    std. error
## t1* 45.084391 -0.003175695   0.4404004
## t2* -1.714546  0.013338149   0.7730368
\end{verbatim}
...
\tightlist
\item
  \texttt{Iter}: la règle a limité à 2370 permutations le calcul. Notez que ce nombre va varier à chaque fois que vous tournerez cet petit bout de code. Ce sont des résultats obtenus par permutations aléatoires, donc vous devez vous attendre à de la variabilité. .
\item
  \texttt{Pr(Prob)}: La p-valeur estimée pour H0 est 0.0405. La différence observée pour fklngth between entre les deux sites était plus grande que les valeurs permutées environ (1 - 0.0405= 95.9\%) des 2370 permutations. Notez que 2370 permutations ce n'est pas un si grand nombre de permutations que ça, et donc les faibles valeurs de p ne sont pas très précises. Si vous voulez des valeurs précises de p, vous devrez faire plus de permutations. Vous pouvez ajuster 2 paramètres: maxIter, le nombre maximal de permutations (défaut 5000) et Ca, le seuil de précision désiré qui arrête les permutations quand l'erreur- type de p est plus petite que Ca*p (défaut=0.1)
\item
...
## Linear Hypotheses:
##                    Estimate lwr      upr     
## m1958 - m1954 == 0   0.1872  -3.2726   3.6470
## m1965 - m1954 == 0  -5.5077  -9.9990  -1.0163
## m1966 - m1954 == 0  -3.3127  -6.3443  -0.2811
## m1965 - m1958 == 0  -5.6949 -10.4131  -0.9766
## m1966 - m1958 == 0  -3.4999  -6.8586  -0.1412
## m1966 - m1965 == 0   2.1950  -2.2190   6.6089
\end{verbatim}
...
## 0.5%  -0.71533776 0.1248316 -0.045072024 0.01582854 -0.0003451633
## 1%    -0.68662679 0.1356427 -0.044052137 0.01716995 -0.0003395765
## 2.5%  -0.64679834 0.1554751 -0.042431112 0.01987952 -0.0003288594
## 5%    -0.59657004 0.1640844 -0.039551469 0.02135504 -0.0003127357
## 95%   -0.08630668 0.2779894 -0.011768095 0.03740812 -0.0001824118
## 97.5% -0.03429523 0.2881732 -0.008895967 0.03973966 -0.0001691517
## 99%    0.02920307 0.3045614 -0.005389649 0.04063830 -0.0001495034
## 99.5%  0.06925794 0.3153114 -0.004013547 0.04153014 -0.0001437199
\end{verbatim}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-335-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-338-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-344-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-344-2.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-344-3.pdf}
