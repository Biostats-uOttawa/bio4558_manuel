...
\hypertarget{objectifs-labo-1}{%
\section{Objectifs Labo 1}\label{objectifs-labo-1}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{revenu_total <-}\StringTok{ }\NormalTok{conjoint1 }\OperatorTok{+}\StringTok{ }\NormalTok{conjoint2}
\NormalTok{revenu_total }\OperatorTok{/}\StringTok{ }\NormalTok{nb_personnes}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{range}\NormalTok{(conjoint1, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mean}\NormalTok{(temperature)}
\KeywordTok{sum}\NormalTok{(precipitations)}
\end{Highlighting}
\end{Shaded}
...
\texttt{cumsum(precipitations)} correspond à la somme cumulée des précipitations sur l'année. Par exemple, la 6e valeur du vecteur résultat correspond au total de précipitations de janvier à juin.

\texttt{diff(temperature)} correspond à la différence de température d'un mois sur l'autre. Par exemple, la 2e valeur de ce vecteur correspond à l'écart de température entre le mois de février et le mois de janvier.
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mean}\NormalTok{(anglais)}
\NormalTok{(maths }\OperatorTok{+}\StringTok{ }\NormalTok{anglais }\OperatorTok{+}\StringTok{ }\NormalTok{sport) }\OperatorTok{/}\StringTok{ }\DecValTok{3}
\end{Highlighting}
\end{Shaded}
...
\texttt{pmin} et \texttt{pmax} renvoient les minimum et maximum ``parallèles'' des trois vecteurs passés en argument. Ainsi, \texttt{pmin} renvoie pour chaque élève la note minimale dans les trois matières, et \texttt{pmax} la note maximale.
...
\begin{figure}
\includegraphics[width=0.75\linewidth]{images/screenshots/rstudio_environment} \caption{Onglet Environment}\label{fig:unnamed-chunk-71}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.75\linewidth]{images/screenshots/rstudio_view_icon} \caption{Icone view}\label{fig:unnamed-chunk-73}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{images/screenshots/rstudio_view} \caption{Interface View}\label{fig:unnamed-chunk-75}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{images/screenshots/rstudio_environment_str} \caption{Structure d'un objet}\label{fig:unnamed-chunk-84}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-101-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-102-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-103-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-115-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-116-1.pdf}
...
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-117-1.pdf}
...
\KeywordTok{data}\NormalTok{(hdv2003)}
\NormalTok{df <-}\StringTok{ }\NormalTok{hdv2003}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(df}\OperatorTok{$}\NormalTok{heures.tv)}
\KeywordTok{sd}\NormalTok{(df}\OperatorTok{$}\NormalTok{heures.tv)}

\KeywordTok{hist}\NormalTok{(df}\OperatorTok{$}\NormalTok{heures.tv, }\DataTypeTok{breaks =} \DecValTok{10}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{freq}\NormalTok{(df}\OperatorTok{$}\NormalTok{trav.imp)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tab <-}\StringTok{ }\KeywordTok{sort}\NormalTok{(}\KeywordTok{table}\NormalTok{(df}\OperatorTok{$}\NormalTok{trav.imp))}
\KeywordTok{barplot}\NormalTok{(tab)}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-132-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-133-1.pdf}
...
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-145-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-150-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-151-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-152-1.pdf}
...
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-160-1.pdf}
--\textgreater{}
...
\KeywordTok{library}\NormalTok{(questionr)}
\KeywordTok{data}\NormalTok{(hdv2003)}
\NormalTok{tab <-}\StringTok{ }\KeywordTok{table}\NormalTok{(hdv2003}\OperatorTok{$}\NormalTok{qualif, hdv2003}\OperatorTok{$}\NormalTok{clso)}

\CommentTok{## Ici la variable indépendante est `qualif`, on calcule donc}
\CommentTok{## les pourcentages lignes}
\KeywordTok{lprop}\NormalTok{(tab)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{boxplot}\NormalTok{(hdv2003}\OperatorTok{$}\NormalTok{heures.tv }\OperatorTok{~}\StringTok{ }\NormalTok{hdv2003}\OperatorTok{$}\NormalTok{occup)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{tapply}\NormalTok{(hdv2003}\OperatorTok{$}\NormalTok{heures.tv, hdv2003}\OperatorTok{$}\NormalTok{occup, mean, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{library}\NormalTok{(questionr)}
\KeywordTok{data}\NormalTok{(rp2012)}
\KeywordTok{plot}\NormalTok{(rp2012}\OperatorTok{$}\NormalTok{dipl_aucun, rp2012}\OperatorTok{$}\NormalTok{proprio)}
\CommentTok{## ou}
\KeywordTok{plot}\NormalTok{(proprio }\OperatorTok{~}\StringTok{ }\NormalTok{dipl_aucun, }\DataTypeTok{data =}\NormalTok{ rp2012)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{salmonella <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"data/salmonella.csv"}\NormalTok{)}

\CommentTok{##creer le graph en utilisant juste la souche sauvage et définir x}
\NormalTok{mygraph <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{subset}\NormalTok{(salmonella, souche }\OperatorTok{==}\StringTok{ "SAUVAGE"}\NormalTok{), }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ ratio))}
\CommentTok{##ajouter des composants graphiques}
\NormalTok{mygraph <-}\StringTok{ }\NormalTok{mygraph }\OperatorTok{+}
\CommentTok{# line densité}
\StringTok{  }\KeywordTok{geom_density}\NormalTok{() }\OperatorTok{+}
\CommentTok{# position des observations}
\StringTok{  }\KeywordTok{geom_rug}\NormalTok{() }\OperatorTok{+}
...
\CommentTok{# distribution normal ajustée}
\StringTok{  }\KeywordTok{stat_function}\NormalTok{(}\DataTypeTok{fun =}\NormalTok{ dnorm,}
                \DataTypeTok{args =} \KeywordTok{list}\NormalTok{(}
                  \DataTypeTok{mean =} \KeywordTok{mean}\NormalTok{(}\KeywordTok{subset}\NormalTok{(salmonella, souche }\OperatorTok{==}\StringTok{ "SAUVAGE"}\NormalTok{)}\OperatorTok{$}\NormalTok{ratio),}
                  \DataTypeTok{sd =} \KeywordTok{sd}\NormalTok{(}\KeywordTok{subset}\NormalTok{(salmonella, souche }\OperatorTok{==}\StringTok{ "SAUVAGE"}\NormalTok{)}\OperatorTok{$}\NormalTok{ratio)}
\NormalTok{                ),}
                \DataTypeTok{color =} \StringTok{"red"}\NormalTok{)}
...
## t1* 1.1919926  0.002569658  0.03314378
## t2* 0.3408557 -0.001866195  0.02625861
\end{verbatim}
...
## Intervals : 
## Level      Normal              Basic         
## 95%   ( 1.124,  1.254 )   ( 1.123,  1.254 )  
## 
## Level     Percentile            BCa          
## 95%   ( 1.130,  1.261 )   ( 1.109,  1.245 )  
...
## Intervals : 
## Level      Normal              Basic         
## 95%   ( 0.2913,  0.3942 )   ( 0.2913,  0.3945 )  
## 
## Level     Percentile            BCa          
## 95%   ( 0.2872,  0.3904 )   ( 0.2992,  0.4054 )  
## Calculations and Intervals on Original Scale
## Some BCa intervals may be unstable
\end{verbatim}
...
## Bootstrap Statistics :
##      original       bias    std. error
## t1* 45.084391 -0.010714771   0.4202628
## t2* -1.714546  0.006574537   0.7719081
\end{verbatim}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-200-1.pdf}
...
## Linear Hypotheses:
##                    Estimate lwr      upr     
## m1958 - m1954 == 0   0.1872  -3.2750   3.6494
## m1965 - m1954 == 0  -5.5077 -10.0021  -1.0132
## m1966 - m1954 == 0  -3.3127  -6.3464  -0.2789
## m1965 - m1958 == 0  -5.6949 -10.4164  -0.9733
## m1966 - m1958 == 0  -3.4999  -6.8610  -0.1389
## m1966 - m1965 == 0   2.1950  -2.2220   6.6120
\end{verbatim}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-207-1.pdf}
\caption{\label{fig:unnamed-chunk-207}Conditions d'application ANOVA model1}
\end{figure}
...
\NormalTok{anova.model2 <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}
  \DataTypeTok{formula =}\NormalTok{ rdwght }\OperatorTok{~}\StringTok{ }\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{location }\OperatorTok{+}\StringTok{ }\NormalTok{sex}\OperatorTok{:}\NormalTok{location,}
  \DataTypeTok{contrasts =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{sex =}\NormalTok{ contr.sum, }\DataTypeTok{location =}\NormalTok{ contr.sum),}
  \DataTypeTok{data =}\NormalTok{ Stu2mdat)}
\KeywordTok{Anova}\NormalTok{(anova.model2, }\DataTypeTok{type =} \DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-212-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-213-1.pdf}
\caption{\label{fig:unnamed-chunk-213}Effet du sexe et du lieu sur le poids des esturgeons}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-222-1.pdf}
\caption{\label{fig:unnamed-chunk-222}Effet du mois et de la profondeur sur la température}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-223-1.pdf}
\caption{\label{fig:unnamed-chunk-223}Conditions d'applications du modèle anova.model4}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-230-1.pdf}
\caption{\label{fig:unnamed-chunk-230}Effet du genotype sur la résistance à la dessication avec un test de Tukey}
\end{figure}
...
\begin{Highlighting}[]
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow =} \KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{, }\DecValTok{2}\NormalTok{))}
\KeywordTok{plot}\NormalTok{(anova.simple)}
\end{Highlighting}
\end{Shaded}
...
\caption{\label{fig:unnamed-chunk-232}Conditions d'applications du modèle anova.simple}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{wmcdat2 <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"data/wmcdat2.csv"}\NormalTok{)}
\NormalTok{wmcdat2}\OperatorTok{$}\NormalTok{species <-}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(wmcdat2}\OperatorTok{$}\NormalTok{species)}
\NormalTok{wmcdat2}\OperatorTok{$}\NormalTok{conc <-}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(wmcdat2}\OperatorTok{$}\NormalTok{conc)}
\NormalTok{anova.model5 <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(o2cons }\OperatorTok{~}\StringTok{ }\NormalTok{species }\OperatorTok{*}\StringTok{ }\NormalTok{conc, }\DataTypeTok{data =}\NormalTok{ wmcdat2)}
\KeywordTok{Anova}\NormalTok{(anova.model5, }\DataTypeTok{type =} \DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-239-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-241-1.pdf}
\caption{\label{fig:unnamed-chunk-241}Comparaison de Tukey des moyennes de consommation d'oxygèn en fonction del la concentration}
\end{figure}
...
\NormalTok{wmc2dat2}\OperatorTok{$}\NormalTok{species <-}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(wmc2dat2}\OperatorTok{$}\NormalTok{species)}
\NormalTok{wmc2dat2}\OperatorTok{$}\NormalTok{conc <-}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(wmc2dat2}\OperatorTok{$}\NormalTok{conc)}
\NormalTok{anova.model7 <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(o2cons }\OperatorTok{~}\StringTok{ }\NormalTok{species }\OperatorTok{*}\StringTok{ }\NormalTok{conc, }\DataTypeTok{data =}\NormalTok{ wmcdat2)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-244-1.pdf}
...
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-247-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-249-1.pdf}
\caption{\label{fig:unnamed-chunk-249}Matrice de rélation et densité pour la richesse spécifique des amphibiens et reptiles}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-250-1.pdf}
\caption{\label{fig:unnamed-chunk-250}Conditions d'applications de la régression de \emph{logherp} sur \emph{logarea}}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model.logcp <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(logherp }\OperatorTok{~}\StringTok{ }\NormalTok{cpfor2, }\DataTypeTok{data =}\NormalTok{ mydata)}
\KeywordTok{summary}\NormalTok{(model.logcp)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model.mcp <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(logherp }\OperatorTok{~}\StringTok{ }\NormalTok{logarea }\OperatorTok{+}\StringTok{ }\NormalTok{cpfor2, }\DataTypeTok{data =}\NormalTok{ mydata)}
\KeywordTok{summary}\NormalTok{(model.mcp)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model.mden <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(logherp }\OperatorTok{~}\StringTok{ }\NormalTok{logarea }\OperatorTok{+}\StringTok{ }\NormalTok{thtden, }\DataTypeTok{data =}\NormalTok{ mydata)}
\KeywordTok{summary}\NormalTok{(model.mden)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model.mtri <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(logherp }\OperatorTok{~}\StringTok{ }\NormalTok{logarea }\OperatorTok{+}\StringTok{ }\NormalTok{cpfor2 }\OperatorTok{+}\StringTok{ }\NormalTok{thtden, }\DataTypeTok{data =}\NormalTok{ mydata)}
\KeywordTok{summary}\NormalTok{(model.mtri)}
\end{Highlighting}
\end{Shaded}
...
3. La valeur de AIC pour les modèles auxquels on enlève ou on ajoute une variable au modèle sélectionné à la première étape.(i.e.~logherp \textasciitilde{} logarea + thtden). Notez qu'aucun des modèles n'a un AIC inférieur à ce modèle.
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#problème avec les données de manquantes dans logherp}
\NormalTok{mysub <-}\StringTok{ }\KeywordTok{subset}\NormalTok{(mydata, }\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(logherp))}
\CommentTok{# ajouter les résidus dans les donnée}
\NormalTok{mysub}\OperatorTok{$}\NormalTok{resloga <-}\StringTok{ }\KeywordTok{residuals}\NormalTok{(model.loga)}
\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ mysub, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ resloga, }\DataTypeTok{x =}\NormalTok{ swamp)) }\OperatorTok{+}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-259-1.pdf}
\caption{\label{fig:unnamed-chunk-259}Relation entre swamp et les résidus de la régression entre logherp et logarea}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model.resloga <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(resloga }\OperatorTok{~}\NormalTok{swamp, mysub)}
\KeywordTok{summary}\NormalTok{(model.resloga)}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  Refaites la régression d'en haut, mais cette fois incluez un terme pour représenter \(swamp^2\) . L'expression devrait apparaître comme: `Y \textasciitilde{} X + I(X\^{}2) . Que concluez-vous? Qu'est-ce que l'examen des résidus de cette régression multiple révèle?
\end{itemize}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model.resloga2 <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(resloga }\OperatorTok{~}\StringTok{ }\NormalTok{swamp }\OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(swamp}\OperatorTok{^}\DecValTok{2}\NormalTok{), mysub)}
\KeywordTok{summary}\NormalTok{(model.resloga2)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow =} \KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{, }\DecValTok{2}\NormalTok{))}
\KeywordTok{plot}\NormalTok{(model.resloga2)}
\end{Highlighting}
\end{Shaded}
...
\caption{\label{fig:unnamed-chunk-262}Relation}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model.poly1 <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}
\NormalTok{  logherp }\OperatorTok{~}\StringTok{ }\NormalTok{logarea }\OperatorTok{+}\StringTok{ }\NormalTok{cpfor2 }\OperatorTok{+}\StringTok{ }\NormalTok{thtden }\OperatorTok{+}\StringTok{ }\NormalTok{swamp }\OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(swamp}\OperatorTok{^}\DecValTok{2}\NormalTok{),}
  \DataTypeTok{data =}\NormalTok{ mydata)}
\KeywordTok{summary}\NormalTok{(model.poly1)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model.poly2 <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}
\NormalTok{  logherp }\OperatorTok{~}\StringTok{ }\NormalTok{logarea }\OperatorTok{+}\StringTok{ }\NormalTok{thtden }\OperatorTok{+}\StringTok{ }\NormalTok{swamp }\OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(swamp}\OperatorTok{^}\DecValTok{2}\NormalTok{),}
  \DataTypeTok{data =}\NormalTok{ mydata)}
\KeywordTok{summary}\NormalTok{(model.poly2)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow =} \KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{))}
\KeywordTok{plot}\NormalTok{(model.poly2)}
\end{Highlighting}
\end{Shaded}

\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-266-1.pdf}
\caption{\label{fig:unnamed-chunk-266}Conditions d'application du modèle \texttt{model.poly2}}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-271-1.pdf}
\caption{\label{fig:unnamed-chunk-271}Graphiques de résidus partiels du modèle \texttt{model.poly2}}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model.nopoly <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}
\NormalTok{  logherp }\OperatorTok{~}\StringTok{ }\NormalTok{logarea }\OperatorTok{+}\StringTok{ }\NormalTok{thtden }\OperatorTok{+}\StringTok{ }\NormalTok{swamp,}
  \DataTypeTok{data =}\NormalTok{ mydata)}
\KeywordTok{crPlots}\NormalTok{(model.nopoly)}
\end{Highlighting}
\end{Shaded}

\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-272-1.pdf}
\caption{\label{fig:unnamed-chunk-272}Graphiques de résidus partiels du modèle \texttt{model.nopoly}}
\end{figure}
...
Cette approche a été suivie dans le package \texttt{MuMIn}. Les comparaisons de modèle par \texttt{AIC}doivent être faites en utilisant exactement le même jeu de données pour chaque modèle.
...
Vous pouvez ensuite faire des graphiques pour voir les résultats.
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-285-1.pdf}
\caption{\label{fig:unnamed-chunk-285}Distribution des estimé par bootstrap pour \texttt{logarea}}
\end{figure}
...
## 0.5%  -0.71499574 0.1331337 -0.047915811 0.01687699 -0.0003465067
## 1%    -0.68830466 0.1419176 -0.044400277 0.01772179 -0.0003388953
## 2.5%  -0.63510615 0.1584012 -0.041794945 0.01935212 -0.0003230369
## 5%    -0.59082091 0.1646999 -0.039783820 0.02090203 -0.0003100371
## 95%   -0.06570970 0.2814622 -0.011455874 0.03712205 -0.0001808533
## 97.5% -0.01066592 0.2903061 -0.009304164 0.03861963 -0.0001689553
## 99%    0.01927518 0.3049747 -0.005947527 0.04081077 -0.0001560370
## 99.5%  0.06514956 0.3124886 -0.003130526 0.04106368 -0.0001480806
\end{verbatim}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-292-1.pdf}
\caption{\label{fig:unnamed-chunk-292-1}Exemple de graphique tiré du fichier d'aide de la fonction stat\_bin}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-292-2.pdf}
\caption{\label{fig:unnamed-chunk-292-2}Exemple de graphique tiré du fichier d'aide de la fonction stat\_bin}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-292-3.pdf}
\caption{\label{fig:unnamed-chunk-292-3}Exemple de graphique tiré du fichier d'aide de la fonction stat\_bin}
\end{figure}
