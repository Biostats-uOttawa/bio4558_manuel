...
## t1* 1.1919926  0.0007495654  0.03365813
## t2* 0.3408557 -0.0005172540  0.02656415
\end{verbatim}
...
## Intervals : 
## Level      Normal              Basic         
## 95%   ( 1.125,  1.257 )   ( 1.119,  1.255 )  
## 
## Level     Percentile            BCa          
## 95%   ( 1.129,  1.265 )   ( 1.116,  1.251 )  
...
## Intervals : 
## Level      Normal              Basic         
## 95%   ( 0.2893,  0.3934 )   ( 0.2907,  0.3979 )  
## 
## Level     Percentile            BCa          
## 95%   ( 0.2838,  0.3910 )   ( 0.2947,  0.4012 )  
## Calculations and Intervals on Original Scale
\end{verbatim}
...
## Bootstrap Statistics :
##      original       bias    std. error
## t1* 45.084391 -0.001254396   0.4368312
## t2* -1.714546  0.022888598   0.7812126
\end{verbatim}
...
La méthode de Tukey est l'une des plus populaires et est facile à utiliser en R (notez cependant qu'il y a un sale petit bogue qui se manifeste quand la variable indépendante peut ressembler à un nombre plutôt qu'un facteur, ce qui explique la petite pirouette avec \texttt{paste} dans mon code):
...
## Linear Hypotheses:
##                    Estimate lwr      upr     
## m1958 - m1954 == 0   0.1872  -3.2739   3.6484
## m1965 - m1954 == 0  -5.5077 -10.0007  -1.0146
## m1966 - m1954 == 0  -3.3127  -6.3455  -0.2799
## m1965 - m1958 == 0  -5.6949 -10.4150  -0.9748
## m1966 - m1958 == 0  -3.4999  -6.8599  -0.1399
## m1966 - m1965 == 0   2.1950  -2.2207   6.6106
\end{verbatim}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-206-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-211-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-221-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-229-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-231-1.pdf}
...
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-238-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-240-1.pdf}
...
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-243-1.pdf}
...
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-246-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-251-2.pdf}
...
\begin{figure}
\centering
\includegraphics{Labo_BIO4558_files/figure-latex/unnamed-chunk-251-3.pdf}
