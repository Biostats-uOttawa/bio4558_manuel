...
## t1* 1.1919926  0.0007845553  0.03436987
## t2* 0.3408557 -0.0003799683  0.02730237
\end{verbatim}
...
## Intervals : 
## Level      Normal              Basic         
## 95%   ( 1.124,  1.259 )   ( 1.124,  1.263 )  
## 
## Level     Percentile            BCa          
## 95%   ( 1.121,  1.260 )   ( 1.112,  1.253 )  
...
## Intervals : 
## Level      Normal              Basic         
## 95%   ( 0.2877,  0.3947 )   ( 0.2834,  0.3940 )  
## 
## Level     Percentile            BCa          
## 95%   ( 0.2877,  0.3983 )   ( 0.2914,  0.4043 )  
## Calculations and Intervals on Original Scale
\end{verbatim}
...
## Bootstrap Statistics :
##      original       bias    std. error
## t1* 45.084391 -0.008109894   0.4414446
## t2* -1.714546  0.034057757   0.7778340
\end{verbatim}
...
\item
  \texttt{Pr(Prob)}: La p-valeur estimée pour H0 est 0.0192. La différence observée pour fklngth between entre les deux sites était plus grande que les valeurs permutées environ (1 - 0.0192= 98.1\%) des 5000 permutations. Notez que 5000 permutations ce n'est pas un si grand nombre de permutations que ça, et donc les faibles valeurs de p ne sont pas très précises. Si vous voulez des valeurs précises de p, vous devrez faire plus de permutations. Vous pouvez ajuster 2 paramètres: maxIter, le nombre maximal de permutations (défaut 5000) et Ca, le seuil de précision désiré qui arrête les permutations quand l'erreur- type de p est plus petite que Ca*p (défaut=0.1)
\item
...
## Linear Hypotheses:
##                    Estimate lwr      upr     
## m1958 - m1954 == 0   0.1872  -3.2737   3.6482
## m1965 - m1954 == 0  -5.5077 -10.0005  -1.0148
## m1966 - m1954 == 0  -3.3127  -6.3454  -0.2800
## m1965 - m1958 == 0  -5.6949 -10.4147  -0.9750
## m1966 - m1958 == 0  -3.4999  -6.8597  -0.1401
## m1966 - m1965 == 0   2.1950  -2.2204   6.6104
\end{verbatim}
...
## 0.5%  -0.760649080 0.1413307 -0.047334023 0.01600645 -0.0003440856
## 1%    -0.713545508 0.1473273 -0.045400025 0.01806853 -0.0003388477
## 2.5%  -0.662391187 0.1596035 -0.043083250 0.01957243 -0.0003244820
## 5%    -0.607923513 0.1680990 -0.040070921 0.02073176 -0.0003140767
## 95%   -0.053416012 0.2813591 -0.012254367 0.03767338 -0.0001797812
## 97.5% -0.009407314 0.2923247 -0.010127889 0.03888722 -0.0001701214
## 99%    0.021455950 0.3011814 -0.007792059 0.04058110 -0.0001560286
## 99.5%  0.080284280 0.3095614 -0.006126734 0.04120786 -0.0001455132
\end{verbatim}
